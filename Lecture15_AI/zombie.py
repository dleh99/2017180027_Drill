...
class Zombie:
    ...
    def prepare_patrol_points(self):
        positions = [(43, 750), (1118, 750), (1050, 530), (575, 200), (235, 33), (575, 220), (1050, 530), (1118, 750)] # 좌표 획득시, 기준 위치가 왼쪽 위
        self.patrol_points = []
        for p in positions:
    ...
    def find_player(self):
        diste2 = (server.boy.x - self.x) ** 2 + (server.boy.y - self.y) ** 2
        if diste2 <= (PIXEL_PER_METER * 10) ** 2:
            print('I Find you')
            return BehaviorTree.SUCCESS
        else:
            self.speed = 0
    ...
    def build_behavior_tree(self):
        ...
        chase_wander_node = SelectorNode('Chase of Wander')
        chase_wander_node.add_children(chase_node, wander_wait_node)
